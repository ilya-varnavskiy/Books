...
def get_metadata():
	...
	return dict({
		...
		"last_modified": '%s %s' % (dt.strftime("%a, %d %b %Y %H:%M:%S"), St.TIME_ZONE),
		"expires": '%s %s' % (exp.strftime("%a, %d %b %Y %H:%M:%S"), St.TIME_ZONE),
		"keywords": 'Books, library',
		"header_title": "BOOKS Library",
		"header_sub_title": "Ваш навигатор в мире книг",
	})
